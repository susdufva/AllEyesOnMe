    ...
    <>
      ...
      <div className="flex flex-col justify-center">
        <div className="relative m-2 flex flex-wrap mx-auto justify-center">
          <div className="relative w-1/2 min-w-[340px] bg-black-900 shadow-lg rounded-md mx-1 my-3 cursor-pointer">
            ...
            <div className="p-2 pl-4 flex justify-between">
              ...
              {/* Cart icon below*/}
              <button className="flex flex-col-reverse mb-2 mr-5 group cursor-pointer">
                <svg
