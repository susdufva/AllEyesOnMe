    ...
    return (
        <body>
            <div className="flex justify-center items-center h-screen mt-12 p-1">
                ...
                <div className="lg:w-1/3 md:w-1/2 w-1/1 h-full mt-12 sm:mt-32 lg:mt-48">
                    <h3 className="text-white font-bold text-sm md:text-2xl lg:text-3xl text-left">Unique Customisations <br/>of Handpicked Frames </h3>
